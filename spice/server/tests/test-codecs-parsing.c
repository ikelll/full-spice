...
static void codecs_good(void)
{
    ...
    const gchar *codecs[] = {
        ...
        "gstreamer:mjpeg;gstreamer:h264;gstreamer:vp8;gstreamer:vp9;gstreamer:h265;gstreamer:av1;",
        ";;spice:mjpeg;;gstreamer:mjpeg;gstreamer:h264;gstreamer:vp8;gstreamer:vp9;gstreamer:h265;gstreamer:av1;",
#endif
    };
